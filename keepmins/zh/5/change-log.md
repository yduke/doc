...
- 修正了喜欢按钮的一些样式，现在计数可以在移动设备显示了
- 当获取地理位置时将保存更多的即时天气信息
- 天气描述将根据WordPress设置语言切换中英文
...
- 完善了JavaScripts的依赖关系
- 适配PI不工作的bug
- 添加了“Flag here”夺旗功能，添加了插旗总览的地图页面模板
- 签到获取地理位置添加更多信息
- 天气信息现在可以显示在天气图标下面了
- 对于社区页面捕友发布的视频做了防治措施，避免全屏视频撑破页面
- 完善了Bilibili视频的发布功能
